...
if __name__ == "__main__":
    ...
    val_results = dataset_transcription["valid"].map(map_to_result,
    ...
    dsing_test_results = dataset_transcription["dsing_test"].map(map_to_result, remove_columns=dataset_transcription[
    ...
    nem_test_results = dataset_transcription["n20em_test"].map(map_to_result, remove_columns=dataset_transcription[
    ...
    df_scores.to_csv("wav2vec2_only_scores.csv")
